...
* What is a coordinate reference system? Why is it important to know what CRS your data are in before you start to work with multiple datasets? Why are there different CRS' for different data?
* When you compare lidar derived tree height to human measured tree height - are they the same thing? Provide 2-3 examples of why lidar may over or under-estimate human measured tree height for a vegetation plot.
