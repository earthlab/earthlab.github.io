...
## ----reproject-robinson, fig.cap="Map plotted using robinson projection."----
# define locations of Boulder, CO and Oslo, Norway
loc.df
...
## ----plot-w-graticules, message=FALSE, warning=FALSE, results='hide', fig.cap="plots in different projections, side by side."----
