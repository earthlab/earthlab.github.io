...
1. `monthly_precip_mm_1998-to-2017.csv` from `https://ndownloader.figshare.com/files/12799931`

2. `monthly_temp_cel_1998-to-2017.csv` from `https://ndownloader.figshare.com/files/12799928`
...
1. What are the dimensions of the `numpy array` you created for precipitation in Question 9? How many values does the `numpy array` contain? How do you know?

2. Why does contain the number of values that it contains? What does each value in the `numpy array` represent?
...
1. What are the dimensions of the `numpy array` you created for temperature in Question 12? How many values does the `numpy array` contain? How do you know?
