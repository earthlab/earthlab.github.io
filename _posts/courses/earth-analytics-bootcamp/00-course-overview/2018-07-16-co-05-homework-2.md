...
{:.execute_result}
    ...
    [Text(0, 0.5, 'Snowfall (mm)'), Text(0.5, 0, 'Month')]
...
<img src = "{{ site.url }}/images/courses/earth-analytics-bootcamp/00-course-overview/2018-07-16-co-05-homework-2/2018-07-16-co-05-homework-2_25_1.png" alt = "This plot displays an example plot of monthly snowfall in 2017 for Boulder, CO.">
