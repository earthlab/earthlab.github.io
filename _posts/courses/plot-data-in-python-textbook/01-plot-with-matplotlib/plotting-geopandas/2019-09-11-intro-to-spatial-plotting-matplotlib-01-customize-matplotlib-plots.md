...
sjer_roads = gpd.read_file(os.path.join("spatial-vector-lidar", 
                                        "california", 
                                        "madera-county-roads", 
...
```python
# Import points layer
sjer_plots = gpd.read_file(os.path.join("spatial-vector-lidar",
                                        "california",
                                        "neon-sjer-site",
                                        "vector_data",
...
<img src = "{{ site.url }}/images/courses/plot-data-in-python-textbook/01-plot-with-matplotlib/plotting-geopandas/2019-09-11-intro-to-spatial-plotting-matplotlib-01-customize-matplotlib-plots/2019-09-11-intro-to-spatial-plotting-matplotlib-01-customize-matplotlib-plots_35_0.png">
...
{:.execute_result}
    ...
    [<matplotlib.collections.PathCollection at 0x7f36762a4700>,
