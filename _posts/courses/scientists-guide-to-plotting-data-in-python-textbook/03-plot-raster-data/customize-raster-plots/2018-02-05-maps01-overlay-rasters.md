...
permalink: /courses/scientists-guide-to-plotting-data-in-python/plot-raster-data/overlay-raster-maps/
...
## <i class="fa fa-ship" aria-hidden="true"></i> Chapter Three - Customize Raster Plots
...
Also you will turn off the legend for the hillshade plot as the legend we want to see is the DEM elevation values.
...
<img src = "{{ site.url }}/images/courses/scientists-guide-to-plotting-data-in-python-textbook/03-plot-raster-data/customize-raster-plots/2018-02-05-maps01-overlay-rasters/2018-02-05-maps01-overlay-rasters_6_0.png" alt = "Plot of the Digital Elevation Model overlayed on top of a hillshade.">
