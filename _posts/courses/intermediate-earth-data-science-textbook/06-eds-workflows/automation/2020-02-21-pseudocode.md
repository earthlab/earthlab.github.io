...
You have now identified your challenge - to calculate and plot average NDVI for every landsat scene individually across one year for two study locations:
...
You have now designed a workflow using pseudocode to process several sites worth of landsat data. Of course, the pseudocode is just beginning. For each of the steps above, you need to flesh out how you can accomplish each task. 
