...
* Resample time series data from hourly to daily using **pandas**.
* Resample time series data from daily to monthly using **pandas**.
* Resample time series data from monthly to yearly using **pandas**.
