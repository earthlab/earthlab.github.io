...
permalink: /courses/use-data-open-source-python/intro-raster-data-python/lidar-raster-data/open-lidar-raster-python/
...
## <i class="fa fa-ship" aria-hidden="true"></i> Chapter Three - Intro to Lidar Raster Data in Python 
...
In the data story on Lidar data, you reviewed the basic principles behind what a lidar raster dataset is and how point clouds are used to derive the raster. 
...
<img src = "{{ site.url }}/images/courses/intermediate-earth-data-science-textbook/03-intro-raster/lidar-raster-intro/2018-02-05-raster01-open-lidar-raster-data-python/2018-02-05-raster01-open-lidar-raster-data-python_41_0.png" alt = "A histogram of lidar derived elevation values for Boulder, CO.">
