...
|===
| Thursdays | 5:15 pm - 7:15 pm | | Christa |
...
<a href="https://cuboulder.zoom.us/j/452337113" target="_blank" class="btn btn-info btn--x-large">Join Earth Analytics online via your web browser: https://cuboulder.zoom.us/j/452337113 </a>

You can also:
* Join via Zoom app (using meeting ID)
* Join via phone: 1-646-558-8656 or 1-408-638-0968

Please note that you will need video capabilities to follow along with the class.
However you can use the phone option to connect audio.
...
1. See if the question has already been asekd on Piazza
2. If the question hasn't been asked, please **post to PIAZZA** for a quicker response time!
