...
| 3:20 - 4:00  | Using data and models to understand the boulder floods   | Dr. Matthew Rossi  |
...
|===
| There is a thoughtful discussion of the relationship between precip, discharge and patterns seen in the lidar pre-post flood data.|| |
...
|  Full Credit | No Credit|
|---|---|
| PLOT 0 - Study area map using `ggmap()` oro maps() is included and the study area location is clearly identified  |  |
...
| PLOT 4: is customized with appropriate titles, axis labels and colors. Plot data source is clearly described in the text & the plot data are interpreted relative to the boulder flood. |
|===
