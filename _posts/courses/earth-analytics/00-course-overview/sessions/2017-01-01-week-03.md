...
Submit your report in both `.Rmd` and `.html` format to the D2l dropbox by NOON Wednesday 8
February 2017.
</div>
...
<img src="{{ site.url }}/images/rfigs/courses/earth-analytics/00-course-overview/sessions/2017-01-01-week-03/homework-09-levelplot-1.png" title=" " alt=" " width="90%" />

## Homework grades & rubric

While most homework assignments are worth 5 points, this homework is worth 10 points as it
