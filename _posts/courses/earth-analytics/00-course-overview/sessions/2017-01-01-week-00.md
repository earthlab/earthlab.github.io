...
by **Mon 11 September 2017 by 9AM Mountain Time.**
...
`yourLastName-firstInitial-week1.Rmd` example: `wasser-l-week01.Rmd`
    * Save your `.Rmd` file in the working directory that you created for this class using the lessons.
...
1. Write a 1 page overview of the events that lead to the flooding that occurred in 2013 and how the floods impacts people in Colorado. NOTE: this text will be used in the final report that you create about the 2013 floods so the better this text is now, the less you will have to do later! Read the articles and craft this write up carefully. Be sure to cite atleast 3 of the articles above (or others that you find) in your write up.
1. Write 1-2 paragraphs that describe:
