...
<img src="{{ site.url }}/images/rfigs/earth-analytics/00-course-overview/sessions/2017-01-01-week-05/unnamed-chunk-3-1.png" title="plot of chunk unnamed-chunk-3" alt="plot of chunk unnamed-chunk-3" width="90%" />


### SJER Difference Plots

<img src="{{ site.url }}/images/rfigs/earth-analytics/00-course-overview/sessions/2017-01-01-week-05/unnamed-chunk-4-1.png" title="plot of chunk unnamed-chunk-4" alt="plot of chunk unnamed-chunk-4" width="90%" />

<img src="{{ site.url }}/images/rfigs/earth-analytics/00-course-overview/sessions/2017-01-01-week-05/unnamed-chunk-5-1.png" title="plot of chunk unnamed-chunk-5" alt="plot of chunk unnamed-chunk-5" width="90%" />

### SJER Scatterplots

<img src="{{ site.url }}/images/rfigs/earth-analytics/00-course-overview/sessions/2017-01-01-week-05/unnamed-chunk-6-1.png" title="plot of chunk unnamed-chunk-6" alt="plot of chunk unnamed-chunk-6" width="90%" />

<img src="{{ site.url }}/images/rfigs/earth-analytics/00-course-overview/sessions/2017-01-01-week-05/unnamed-chunk-7-1.png" title="plot of chunk unnamed-chunk-7" alt="plot of chunk unnamed-chunk-7" width="90%" />
...
## Error in soap_chm[soap_chm == 0] <- NA: object 'soap_chm' not found
```
...
```
## Error in paste0("SOAP", soap_plots$ID): object 'soap_plots' not found
## Error in raster::extract(soap_chm, soap_plots, buffer = 20, fun = mean, : object 'soap_chm' not found
## Error in colnames(soap_mean_height@data)[8] <- "SOAP_lidar_meanht": object 'soap_mean_height' not found
## Error in raster::extract(soap_chm, soap_plots, buffer = 20, sp = TRUE, : object 'soap_chm' not found
## Error in colnames(soap_max_height@data)[8] <- "SOAP_lidar_maxht": object 'soap_max_height' not found
## Error in plot(soap_chm, main = "Soaproot Saddle Plot Locations \n Southern California", : object 'soap_chm' not found
## Error in plot(soap_max_height, pch = 16, cex = (soap_max_height$SOAP_lidar_maxht)/20, : object 'soap_max_height' not found
## Warning in file(file, "rt"): cannot open file 'data/week_05/california/
## soap/2013/insitu/veg-structure/D17_2013_SOAP_vegStr.csv': No such file or
## directory
## Error in file(file, "rt"): cannot open the connection
## Error in eval(lhs, parent, parent): object 'soap_insitu' not found
## Error in merge(soap_mean_height, soap_insitu_stem_height, by.x = "plotid", : object 'soap_mean_height' not found
## Error in eval(lhs, parent, parent): object 'soap_max_height' not found
## Error in merge(soap_height, soap_max_height, by.x = "plotid", by.y = "plotid"): object 'soap_height' not found
```
...
```
## Error in eval(expr, envir, enclos): object 'soap_height2' not found
## Error in eval(lhs, parent, parent): object 'soap_height_df' not found
## Error in ggplot(data = soap_height_df, aes(x = ID, y = insitumean_lidarmean, : object 'soap_height_df' not found
```



```
## Error in ggplot(data = soap_height_df, aes(x = ID, y = insitumax_lidarmax, : object 'soap_height_df' not found
```
