...
<img src="{{ site.url }}/images/rfigs/courses/earth-analytics/week03/hw-ggmap-markdown/2017-02-01-hw02-ggmap/create-us-map-1.png" title="vector map of the US" alt="vector map of the US" width="90%" />
...
<img src="{{ site.url }}/images/rfigs/courses/earth-analytics/week03/hw-ggmap-markdown/2017-02-01-hw02-ggmap/create-us-map-colors-1.png" title="vector map of the US with colors" alt="vector map of the US with colors" width="90%" />
...
<img src="{{ site.url }}/images/rfigs/courses/earth-analytics/week03/hw-ggmap-markdown/2017-02-01-hw02-ggmap/create-CO-map-colors-1.png" title="vector map of the CO with colors" alt="vector map of the CO with colors" width="90%" />
...
<img src="{{ site.url }}/images/rfigs/courses/earth-analytics/week03/hw-ggmap-markdown/2017-02-01-hw02-ggmap/create-map-1.png" title="Create final map" alt="Create final map" width="90%" />
...
<img src="{{ site.url }}/images/rfigs/courses/earth-analytics/week03/hw-ggmap-markdown/2017-02-01-hw02-ggmap/create-plot-1.png" title="map of the United States" alt="map of the United States" width="90%" />
