...
## Homework Plot 2: Landsat Difference dNBR


{:.input}
```python
colors = ["white", "tan", "springgreen", "darkgreen"]
...
norm = mpl.colors.BoundaryNorm(classes, 5)


tick_loc = [np.mean([norm.boundaries[ii], norm.boundaries[ii - 1]])
