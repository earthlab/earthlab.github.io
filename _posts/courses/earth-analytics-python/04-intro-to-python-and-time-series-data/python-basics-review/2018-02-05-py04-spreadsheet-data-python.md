...
<img src = "{{ site.url }}/images/courses/earth-analytics-python/04-intro-to-python-and-time-series-data/python-basics-review/2018-02-05-py04-spreadsheet-data-python/2018-02-05-py04-spreadsheet-data-python_23_0.png" alt = "Here dataframe.plot.bar() is also using the pandas plot function to create a bar plot.">
...
<img src = "{{ site.url }}/images/courses/earth-analytics-python/04-intro-to-python-and-time-series-data/python-basics-review/2018-02-05-py04-spreadsheet-data-python/2018-02-05-py04-spreadsheet-data-python_26_0.png" alt = "Notice here you use ax.plot. This is matplotlib plotting not pandas.">
