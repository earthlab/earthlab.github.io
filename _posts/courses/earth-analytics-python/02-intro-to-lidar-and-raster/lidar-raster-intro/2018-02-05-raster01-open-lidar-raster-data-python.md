...
2. turn off the axes given you don't need the coordinates in your plot
3. increase the title font size using the `as.set_title` function and the `fontsize` argument 
