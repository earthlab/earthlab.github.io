...
<img src="{{ site.url }}/images/courses/earth-analytics-r/02-time-series-data/get-to-know-r/quick-plot-1.png" title="quick plot of temperature" alt="quick plot of temperature" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/02-time-series-data/get-to-know-r/plot-2nodata-1.png" title="Plot of temperature with missing data accounted for" alt="Plot of temperature with missing data accounted for" width="90%" />
