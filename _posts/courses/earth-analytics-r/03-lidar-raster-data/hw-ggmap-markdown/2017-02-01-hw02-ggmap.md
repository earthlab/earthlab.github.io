...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/create-base-map-1.png" title="ggmap base plot" alt="ggmap base plot" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/create-base-map3-1.png" title="ggmap base plot" alt="ggmap base plot" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/add-points-to-map-1.png" title="ggmap with location point on it. " alt="ggmap with location point on it. " width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/create-us-map-1.png" title="vector map of the US" alt="vector map of the US" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/create-us-map-colors-1.png" title="vector map of the US with colors" alt="vector map of the US with colors" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/create-CO-map-colors-1.png" title="vector map of the CO with colors" alt="vector map of the CO with colors" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/create-map-1.png" title="Create final map" alt="Create final map" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/03-lidar-raster-data/hw-ggmap-markdown/create-plot-1.png" title="map of the United States" alt="map of the United States" width="90%" />
