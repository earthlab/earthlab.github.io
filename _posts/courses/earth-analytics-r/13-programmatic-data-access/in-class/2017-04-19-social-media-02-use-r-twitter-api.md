...
## 1 912475… 11639001… 2019-08-20 19:46:33 Benguimbis  "In … Twitt…
## 2 414359… 11639000… 2019-08-20 19:46:17 jimhester_  "gar… Twitt…
## 3 414359… 11638443… 2019-08-20 16:04:38 jimhester_  "Som… Twitt…
...
##   user_id status_id created_at          screen_name text  source
##   <chr>   <chr>     <dttm>              <chr>       <chr> <chr> 
## 1 218112… 11638996… 2019-08-20 19:44:42 vjjan91     #rst… Twitt…
## 2 310778… 11638993… 2019-08-20 19:43:20 AbsLawson   "For… Twitt…
## # … with 84 more variables: display_text_width <dbl>,
## #   reply_to_status_id <chr>, reply_to_user_id <chr>,
## #   reply_to_screen_name <chr>, is_quote <lgl>, is_retweet <lgl>,
## #   favorite_count <int>, retweet_count <int>, quote_count <int>,
...
## [1] "vjjan91"     "AbsLawson"   "AbsLawson"   "chrisprener" "chrisprener"
## [6] "chrisprener"
# get a list of unique usernames
unique(rstats_tweets$screen_name)
##   [1] "vjjan91"         "AbsLawson"       "chrisprener"    
##   [4] "Rbloggers"       "oscar_b123"      "DerFredo"       
##   [7] "dataclaudius"    "phillynerd"      "neptanum"       
##  [10] "aswansyahputra_" "heiheibike"      "DataDaft"       
##  [13] "sckottie"        "Juanma_MN"       "benmarwick"     
##  [16] "joscani"         "rstatsdata"      "daniellequinn88"
##  [19] "CRANberriesFeed" "sellorm"         "joranelias"     
##  [22] "BristolRUsers"   "fubits"          "chrismainey"    
##  [25] "gjmount"         "NumFOCUS"        "datalorax_"     
##  [28] "mrander04198742" "jozefhajnala"    "katiedrax"      
##  [31] "UBCRCommons"     "kai_arzheimer"   "RLangTip"       
##  [34] "tangming2005"    "lobrowR"         "ethantenison"   
##  [37] "lucidmanager"    "PodsProgram"     "TimSalabim3"    
##  [40] "dccc_phd"        "marcus_lyall"    "pakinproton"    
##  [43] "jrmhyrm"         "nsgrantham"      "Mayacelium"     
##  [46] "gztstatistics"   "mercuriusio"     "KStackWhitney"  
##  [49] "tidyversetweets" "dataandme"       "ryjohnson09"    
##  [52] "JennyBryan"      "schochastics"    "FionaMUnderwood"
##  [55] "datasartoriasf"  "emiliegeiss"     "Catarina_Noir"  
##  [58] "pabloc_ds"       "statsdavew"      "RevDocGabriel"  
##  [61] "DavidBordonaba"  "haematobot"      "FelixEVargas"   
##  [64] "fani_ko"         "BigData_Fr"      "tahirenesgedik" 
##  [67] "SamanthaLWilson" "CivicAngela"     "trappedalien"   
##  [70] "JasonTimm13"     "_Gil_Henriques"  "JonAskonas"     
##  [73] "RSGTurkey"       "LarsESchonander" "Corey_Yanofsky" 
##  [76] "thanhtungmilan"  "matloff"         "MattOldach"     
##  [79] "jrosenberg6432"  "Mbiguidi1"       "jgianoglio"     
##  [82] "OmniAnalytics"   "lefevreromain_"  "rOpenSci"       
##  [85] "UhKaren"         "CharlesBordet"   "ludmila_janda"  
##  [88] "sascha_wolfer"   "wlharder"        "DataScientistsF"
##  [91] "AnalyticsFrance" "genomicsdoc"     "expersso"       
##  [94] "MKumarYYC"       "mribeirodantas"  "gp_pulipaka"    
##  [97] "robinson_es"     "ashbaldry_"      "bwundervald"    
## [100] "YazidKurdiR"     "frau_dr_barber"  "RLadiesCanberra"
## [103] "gbganalyst"      "SportSciData"    "dataquestio"    
## [106] "rweekly_live"    "wia_conference"  "noamross"       
## [109] "PerriLane"       "bj_cairns"       "CIGP_EC"        
## [112] "harrocyranka"    "moorejh"         "Xtophe_Bontemps"
## [115] "chringer_tweet"  "WeAreRLadies"    "FournierJohanie"
## [118] "vbacak"          "mikhaeldito313"  "IndranilGayen"  
## [121] "AnalystsAmerica" "JulieTheBatgirl" "caprico_aries"  
## [124] "anjagarone"      "StockViz"        "tylermorganwall"
## [127] "brennanpcardiff" "traffordDataLab" "ARCHAEOfelix"   
## [130] "appsilon"        "be_alexandria"   "evalparse"      
## [133] "LandbouLisa"     "peterdalle"      "oSCR_package"   
## [136] "mario_angst_sci" "mattthereed"     "lucazav"        
## [139] "Gwmngilfen"      "fabiopss"        "MangoTheCat"    
## [142] "apavluhina"      "RLangPackage"    "neotomadb"      
## [145] "LearnRinaDay"    "coolbutuseless"  "minebocek"      
## [148] "BenceArato"      "Kristen_Osb"     "BudapestBI"     
## [151] "chrisbrunsdon"   "JosephCrispell"  "_PoppyBrown"    
## [154] "robinlovelace"   "thinkR_fr"       "StatistikInDD"  
## [157] "DSL_power"       "NHSrCommunity"   "krlmlr"         
## [160] "JonathanAtyeo"   "whyRconf"        "FreqFrequentist"
## [163] "DSeernani"       "ariamsita"       "dataknut"       
## [166] "erikaris"        "AtomicZest"      "philip_khor"    
## [169] "jubyshu"         "littlefabshop"   "NNBT1337x"      
## [172] "dsquintana"      "asiflaldin"      "jacnah63"       
## [175] "ninsiimasyl"     "NeptuneML"       "wpacademypro"   
## [178] "AppliedInfoNott" "rushworth_a"     "AlexisLNorris"  
## [181] "C_Pritzkow"      "freddy1876"      "nelsonpray"     
## [184] "faroloye"        "LagosRUsers"     "MargaretBrisbin"
## [187] "obergr"          "rstudio"         "julianlavila"   
## [190] "DeborahPassey"   "ClinicalOutlier" "daily_r_sheets" 
## [193] "fishiintheC"     "r0mymendez"      "delany_ramirez" 
## [196] "JenRichmondPhD"  "PhilSmith26"     "BrodieGaslam"   
## [199] "phiala"          "pachamaltese"    "eddelbuettel"   
## [202] "dantonnoriega"   "f_g_zampieri"    "THEAdamGabriel" 
## [205] "mccord_se"       "KirkDBorne"      "LuisDVerde"     
## [208] "jesssileee"      "ImADataGuy"      "westgatecology" 
## [211] "5amStats"        "Heldt8"          "W_R_Chase"      
## [214] "RishabhKumar_"   "GrantHumphries"  "IhaddadenFodil" 
## [217] "TripNyssa"       "EikoFried"       "rstats_meetings"
## [220] "BurnResearch"    "EpiEllie"        "Cocotross"      
## [223] "BenjaminWolfe"   "iamreddave"      "smussenden"     
## [226] "zoowalk"         "CapleAlex"       "nic_crane"      
## [229] "ZimanaAnalytics" "BigAntsAreSmall" "HenriWallen"    
## [232] "jspairani"       "MsChristineB"    "csgillespie"    
## [235] "kristophrdelane" "Hondunauta1"     "StatStas"       
## [238] "bergelsonlab"    "rocitations"     "re_milos"       
## [241] "seabbs"          "hglanz"          "rstatsdc"       
## [244] "sbhagerty"       "RLadiesMTL"      "Rhys_Search"    
## [247] "fillupt"         "sophie_e_hill"   "mf_viz"         
## [250] "jdossgollin"     "AdamRingler"     "potterzot"      
## [253] "TazPoltorak"     "cjlortie"        "elliot_mcbride" 
## [256] "RLadiesDenBosch" "daranzolin"      "SorenWilke"     
## [259] "RachelJPearson"  "parttimeanalyst" "pcanovastourne" 
## [262] "hamiltonulmer"   "TLHolme"         "zecojls"        
## [265] "cimentadaj"      "mzano17"         "SLUDSS"         
## [268] "m_a_upson"       "Tall_Viking"     "hfcfrick"       
## [271] "quaesita"        "yannickabreton"  "mzhang13"       
## [274] "JanSalecker"     "ShiXiong3"       "crimoneva"      
## [277] "healthandstats"  "__jsta"          "owenjonesuob"   
## [280] "jtrecenti"       "vee_burton"      "M_Araya_Salas"  
## [283] "martin_rstats"   "gvegayon"        "tuf"            
## [286] "solomilne"       "dp_moriarity"    "rfortherest"    
## [289] "dgwinfred"
```
...
## 2 101181… 11638978… 2019-08-20 19:37:37 rstatstweet Wow,… rstat…
## # … with 84 more variables: display_text_width <dbl>,
## #   reply_to_status_id <chr>, reply_to_user_id <chr>,
## #   reply_to_screen_name <chr>, is_quote <lgl>, is_retweet <lgl>,
## #   favorite_count <int>, retweet_count <int>, quote_count <int>,
