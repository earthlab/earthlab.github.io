...
<img src="{{ site.url }}/images/courses/earth-analytics-r/13-programmatic-data-access/plot-top-words-1.png" title="words found in tweets during and after the Boulder floods" alt="words found in tweets during and after the Boulder floods" width="90%" />
...
<img src="{{ site.url }}/images/courses/earth-analytics-r/13-programmatic-data-access/male-population-1.png" title="Male population ages 60-80." alt="Male population ages 60-80." width="90%" />
