...
permalink: /courses/intro-to-earth-data-science/git-github/version-control/pull-requests-to-update-github-repositories/
...
* Make reverse pull request to pull changes into a new page?
