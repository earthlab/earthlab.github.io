...
excerpt: "This section introduces useful Bash commands for accessing and working with directories and files on your computer."
authors: ['Jenny Palomino', 'Leah Wasser']
category: [courses]
class-lesson: ['bash']
permalink: /courses/intro-to-earth-analytics/bash/useful-bash-commands/
nav-title: "Useful Bash Commands"
...
In this section, you will learn useful `Bash` commands for accessing and working with directories and files on your computer. 
