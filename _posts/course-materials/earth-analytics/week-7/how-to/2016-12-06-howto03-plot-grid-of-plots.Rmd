...
```{r crop-naip-imagey,results='hide', message=F, warning=F}
# load libraries
library(raster)
library(rgeos)
library(rgdal)
...
```{r import-boundary, results="hide", echo=F}
...
```{r plot-grid-naip-modis-landsat, echo=F, fig.width=7, fig.height=9 }
# NAIP
