...
permalink: /course-materials/earth-analytics/week-10/intro-to-programmatic-data-access-r/
nav-title: "API Intro"
module-title: "Introduction to programmatic data access in R please"
...
1. direct downloads of data and
...
Then we work with the in `R`. The data that we have downloaded
...
* we are trying to download lots of data or particular subsets of data to support an analysis and
* if and when there are programmatic ways to access the data online.
...
selves of our process - we are also reminding our future selve where (and how)
...
learn more about this in the next lesson. However it is important to not that
when we do this, we are not, by default saving a copy of our data locally, on our
computer.
