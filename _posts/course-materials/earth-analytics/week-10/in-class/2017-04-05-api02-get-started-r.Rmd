...
```{r boulder-precip, fig.cap="Boulder precip data plot."}
# read data into R
...
```{r import-plot-data, fig.cap="boulder precip from figshare plot. "}
...
```{r birth-rates, fig.cap="Birth rates example"}
...
```{r all-data, echo=FALSE, fig.cap="Prof salary data by sex"}
...
```{r facet-by-rank, echo=FALSE, fig.cap="GGPLOT of salary by experience"}
...
```{r all-data-lm, echo=FALSE, fig.cap="GGPLOT of gapminder data - life expectance by continent by sex"}
ggplot(salary_data, aes(x=yr, y=sl, col=sx)) +
  geom_point() +
      labs(x="Experience (years)",
           y="Salary (US dollars)",
