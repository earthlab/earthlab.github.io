...
```{r geographic-WGS84, echo=FALSE, message=FALSE, results='hide', fig.cap="wgs 84 plot"}
# read shapefile
...
```{r plot-wgs842, fig.cap="Plot location - wgs84"}
...
```{r plot-world-map, fig.cap="global map in wgs84 with points"}
