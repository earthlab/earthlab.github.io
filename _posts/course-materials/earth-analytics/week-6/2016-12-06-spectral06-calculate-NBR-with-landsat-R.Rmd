...
```{r calculate-nbr, echo=F, fig.cap="landsat derived NDVI plot", fig.width=7, fig.height=5}
...
```{r calculate-nbr-post, echo=F, fig.cap="landsat derived NBR post fire", fig.width=7, fig.height=5}
# Landsat 8 requires bands 7 and 5
...
```{r classify-output-plot, echo=F, fig.cap="classified NBR output", fig.width=7, fig.height=5}
...
```{r classify-output-plot2, echo=F, fig.cap="classified NBR output", results='hide', fig.width=7, fig.height=5}
...
```{r classify-output-plot3, echo=F, fig.cap="classified NBR output", fig.width=7, fig.height=5}
# look at colors
# display.brewer.all()
...
```{r dev-off, echo=F, warning=F, message=F, results="hide", fig.width=7, fig.height=5}
dev.off()
```


```{r view-bar, warning=F, fig.cap="plot barplot of fire severity values"}
...
```{r view-barplot1, warning=F, fig.cap="plot barplot of fire severity values with labels"}
barplot(nbr_classified,
        main="Distribution of Classified NBR Values",
        col=the_colors,
