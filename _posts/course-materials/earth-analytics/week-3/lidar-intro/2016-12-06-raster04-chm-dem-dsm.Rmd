...
```{r dem, fig.cap="digital elevation model plot" }
# open raster data
...
```{r dsm, fig.cap="digital surface model plot" }
# open raster data
...
```{r chm, fig.cap="canopy height model plot" }
# open raster data
...
```{r chm-breaks, fig.cap="canopy height model breaks", warning=FALSE}
# plot raster data
plot(lidar_chm,
