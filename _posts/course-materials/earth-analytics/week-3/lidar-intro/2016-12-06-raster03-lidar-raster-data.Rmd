...
```{r open-plot-raster, fig.cap="digital surface model raster plot" }
# open raster data
...
```{r plot-zoomed-in-raster, fig.cap="zoom in on a small part of a raster - see the pixels?" }
...
```{r view-hist, fig.cap="histogram of DEM elevation values"}
# plot histogram
hist(lidar_dem,
...
```{r class-challenge, echo=F, fig.cap="DSM histogram and plot"}
