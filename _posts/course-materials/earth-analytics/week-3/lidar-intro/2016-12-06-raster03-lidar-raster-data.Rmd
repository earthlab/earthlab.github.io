...
```{r open-plot-raster, fig.caption="digital surface model raster plot" }
...
```{r plot-zoomed-in-raster, fig.caption="zoom in on a small part of a raster - see the pixels?" }
