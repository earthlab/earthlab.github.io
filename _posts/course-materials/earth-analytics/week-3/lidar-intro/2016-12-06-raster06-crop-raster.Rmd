...
```{r plot-w-legend, warning=FALSE, message=FALSE, fig.cap="shapefile crop extent plot"}
...
```{r crop-and-plot-raster, fig.cap="lidar chm cropped with vector extent on top"}
