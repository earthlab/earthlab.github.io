...
```{r plot-world-data, echo=FALSE, fig.cap="Plot of the world boundary using ggplot2."}
...
```{r reproject-robinson1, fig.cap="Map plotted using robinson projection."}
...
```{r plot-new-map, fig.cap="Map of the globe in robinson projection."}
...
```{r plot-w-graticules, results='hide'}
...
```{r plot-grat, fig.cap="graticules plot"}
# plot graticules
ggplot() +
...
```{r render-maps, fig.cap="plots in different projections, side by side."}
require(gridExtra)
