...
{:.output}
    ...
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    cp SRTM1.vrt SRTM1.849db0fc570148389e3cc30683746fc6.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 -projwin -122.6 41.6 -121.9 41.15 SRTM1.849db0fc570148389e3cc30683746fc6.vrt /root/earth-analytics-lessons/Shasta-30m-DEM.tif
    rm -f SRTM1.849db0fc570148389e3cc30683746fc6.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
