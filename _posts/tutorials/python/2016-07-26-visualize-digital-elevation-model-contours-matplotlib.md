...
{:.output}
    ...
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    cp SRTM1.vrt SRTM1.23d04ef7e24c4e7ea5c9370774ffabad.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 -projwin -122.6 41.6 -121.9 41.15 SRTM1.23d04ef7e24c4e7ea5c9370774ffabad.vrt /root/earth-analytics-lessons/Shasta-30m-DEM.tif
    rm -f SRTM1.23d04ef7e24c4e7ea5c9370774ffabad.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
