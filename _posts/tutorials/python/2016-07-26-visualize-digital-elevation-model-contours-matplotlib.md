...
{:.output}
    ...
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    cp SRTM1.vrt SRTM1.6120a14736a54b6681df2b8f7baaf4b7.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 -projwin -122.6 41.6 -121.9 41.15 SRTM1.6120a14736a54b6681df2b8f7baaf4b7.vrt /root/earth-analytics-lessons/Shasta-30m-DEM.tif
    rm -f SRTM1.6120a14736a54b6681df2b8f7baaf4b7.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
