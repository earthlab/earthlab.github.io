...
{:.output}
    ...
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    cp SRTM1.vrt SRTM1.99afe9a97bc04fc0a0b1f5c2f3e445d9.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
    make: Entering directory '/root/.cache/elevation/SRTM1'
    gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 -projwin -122.6 41.6 -121.9 41.15 SRTM1.99afe9a97bc04fc0a0b1f5c2f3e445d9.vrt /root/earth-analytics-lessons/Shasta-30m-DEM.tif
    rm -f SRTM1.99afe9a97bc04fc0a0b1f5c2f3e445d9.vrt
    make: Leaving directory '/root/.cache/elevation/SRTM1'
