...
# set series subdir
subDir <- "dc-spatial-intro/"

# don't change - this is the posts dir location required by jekyll
postsDir <- paste0("_posts/class-lessons/R/", subDir)
...
# note this will fail if the sub dir doesn't exist
if (dir.exists(paste0(gitRepoPath, imagePath))){
...
if (dir.exists(paste0(gitRepoPath, codeDir))){
