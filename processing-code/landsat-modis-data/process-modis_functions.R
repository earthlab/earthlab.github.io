...
#the_file_7bands <- "data/week6/modis/reflectance/17_july_2016/MOD09GA.A2016199.h09v05.006.2016201065406.hdf"

### Process_modis_bands
# input : the_file_7_bands - path to the h4 file
process_modis_bands <- function(the_file_7bands){
  ...
  export_modis_as_tif(h4_layers[2], the_file_7bands)
